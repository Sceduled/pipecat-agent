...
async def run_inbound(
    ...
    stt = create_stt_service(provider=stt_provider, model=stt_model, language=stt_language, prewarmed=False, keywords=stt_keywords, timeout=stt_timeout, eager=stt_eager)
